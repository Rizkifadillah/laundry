            ...
            <form role="form" method="post" action="{{ url('customer/'.$dt->id)}}">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" value="{{ $dt->email}}"  name="email" id="" placeholder="Email">
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">No Handphone</label>
                  <input type="number" class="form-control" value="{{ $dt->no_hp}}" name="no_hp" id="" placeholder="No Handphone">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Alamat</label>
                  <textarea class="form-control" name="alamat"  id="" rows="4">{{ $dt->alamat}}</textarea>
